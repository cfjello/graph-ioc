...
dataTables.set('LOAD_LIST', `CREATE TABLE IF NOT EXISTS LOAD_LIST (
...
dataTables.set('Stations', `CREATE TABLE IF NOT EXISTS Stations ( 
...
dataTables.set( 'MEASUREMENTS', `CREATE TABLE IF NOT EXISTS MEASUREMENTS (
...
dataTables.set( 'Air', `CREATE TABLE IF NOT EXISTS Air (
    STATION     VARCHAR(11) NOT NULL,
    MDATE       DATE NOT NULL,
    TMAX        SMALLINT,
    TMIN        SMALLINT,
    ...
    TAVG_MFLAG  CHAR(1),
    TAVG_QFLAG  CHAR(1),
    CONSTRAINT Air_PK PRIMARY KEY ( STATION, MDATE ),
    FOREIGN KEY(STATION) REFERENCES Stations(STATION) ON DELETE CASCADE
)
WITH (autovacuum_enabled=false)`
)

dataTables.set('Rain', `CREATE TABLE IF NOT EXISTS Rain (
    STATION     VARCHAR(11) NOT NULL,
    MDATE       DATE NOT NULL,
    PRCP        SMALLINT, 
    MFLAG       CHAR(1),
    QFLAG       CHAR(1),
    SFLAG       CHAR(1),
    CONSTRAINT Rain_PK PRIMARY KEY ( STATION, MDATE ),
    FOREIGN KEY(STATION) REFERENCES Stations(STATION) ON DELETE CASCADE
)
WITH (autovacuum_enabled=false)`
)

dataTables.set('Snow', `CREATE TABLE IF NOT EXISTS Snow (
    STATION     VARCHAR(11) NOT NULL,
    MDATE       DATE NOT NULL,
    SNOW        SMALLINT,  
    SNWD        SMALLINT,
    ...
    QFLAG       CHAR(1),
    SFLAG       CHAR(1),
    CONSTRAINT Snow_PK PRIMARY KEY ( STATION, MDATE ),
    FOREIGN KEY(STATION) REFERENCES Stations(STATION) ON DELETE CASCADE
)
WITH (autovacuum_enabled=false)`
)

dataTables.set('Sun', `CREATE TABLE IF NOT EXISTS Sun (
    STATION     VARCHAR(11) NOT NULL,
    MDATE       DATE NOT NULL,
    PSUN        SMALLINT, 
    TSUN        SMALLINT,
    ...
    QFLAG       CHAR(1),
    SFLAG       CHAR(1),
    CONSTRAINT Sun_PK PRIMARY KEY ( STATION, MDATE ),
    FOREIGN KEY(STATION) REFERENCES Stations(STATION) ON DELETE CASCADE
)
WITH (autovacuum_enabled=false)`
)

dataTables.set('Ice', `CREATE TABLE IF NOT EXISTS Ice (
    STATION     VARCHAR(11) NOT NULL,
    MDATE       DATE NOT NULL,
    THIC        SMALLINT, 
    MFLAG       CHAR(1),
    QFLAG       CHAR(1),
    SFLAG       CHAR(1),
    CONSTRAINT Ice_PK PRIMARY KEY ( STATION, MDATE ),
    FOREIGN KEY(STATION) REFERENCES Stations(STATION) ON DELETE CASCADE
)
WITH (autovacuum_enabled=false)`
)

dataTables.set('Evaporation', `CREATE TABLE IF NOT EXISTS Evaporation (
    STATION    VARCHAR(11) NOT NULL,
    MDATE      DATE NOT NULL,
    MNPN       SMALLINT,
    MXPN       SMALLINT,
    ...
    MFLAG      CHAR(1),
    QFLAG      CHAR(1),
    CONSTRAINT Evaporation_PK PRIMARY KEY ( STATION, MDATE ),
    FOREIGN KEY(STATION) REFERENCES Stations(STATION) ON DELETE CASCADE
)
WITH (autovacuum_enabled=false)`
)

dataTables.set('Cloud', `CREATE TABLE IF NOT EXISTS Cloud (
    STATION       VARCHAR(11) NOT NULL,
    MDATE         DATE NOT NULL,
    ACMC          SMALLINT,
    ACMH          SMALLINT,
    ...
    MFLAG       CHAR(1),
    QFLAG       CHAR(1),
    CONSTRAINT Cloud_PK PRIMARY KEY ( STATION, MDATE ),
    FOREIGN KEY(STATION) REFERENCES Stations(STATION) ON DELETE CASCADE
)
WITH (autovacuum_enabled=false)`
)

dataTables.set('Weather', `CREATE TABLE IF NOT EXISTS Weather (
    STATION     VARCHAR(11)  NOT NULL,
    MDATE       DATE NOT NULL, 
    WT          CHAR(4),
    WT_MFLAG    CHAR(1),
    ...
    WV_QFLAG    CHAR(1),
    WV_SFLAG    CHAR(1),
    CONSTRAINT Weather_PK PRIMARY KEY ( STATION, MDATE ),
    FOREIGN KEY(STATION) REFERENCES Stations(STATION) ON DELETE CASCADE
)
WITH (autovacuum_enabled=false)`
)

dataTables.set('Wind', `CREATE TABLE IF NOT EXISTS Wind (
    STATION    VARCHAR(11)  NOT NULL,
    MDATE      DATE NOT NULL,
    AWDR          SMALLINT,
    AWND          SMALLINT,
    ...
    QFLAG       CHAR(1),
    SFLAG       CHAR(1),
    CONSTRAINT Wind_PK PRIMARY KEY ( STATION, MDATE ),
    FOREIGN KEY(STATION) REFERENCES Stations(STATION) ON DELETE CASCADE
)
WITH (autovacuum_enabled=false)`
)

dataTables.set('Soil', `CREATE TABLE IF NOT EXISTS Soil (
    STATION    VARCHAR(11)  NOT NULL,
    MDATE      DATE NOT NULL,
    SN_MIN      SMALLINT,
    SX_MAX      SMALLINT,
    ...
    QFLAG       CHAR(1),
    SFLAG       CHAR(1),
    CONSTRAINT Soil_PK PRIMARY KEY ( STATION, MDATE ),
    FOREIGN KEY(STATION) REFERENCES Stations(STATION) ON DELETE CASCADE
)
WITH (autovacuum_enabled=false)`
)

dataTables.set('Air_MD',  `CREATE TABLE IF NOT EXISTS Air_MD (
    STATION     VARCHAR(11) NOT NULL,
    MDATE       DATE NOT NULL,
    MDTN        SMALLINT,
    DATN        SMALLINT,
    ...
    QFLAG       CHAR(1),
    SFLAG       CHAR(1),
    CONSTRAINT Air_MD_PK PRIMARY KEY ( STATION, MDATE ),
    FOREIGN KEY(STATION) REFERENCES Stations(STATION) ON DELETE CASCADE
)
WITH (autovacuum_enabled=false)`
)

dataTables.set('Rain_MD', `CREATE TABLE IF NOT EXISTS Rain_MD (
    STATION     VARCHAR(11) NOT NULL,
    MDATE       DATE NOT NULL,
    MDPR        SMALLINT,
    DAPR        SMALLINT,
    ...
    QFLAG       CHAR(1),
    SFLAG       CHAR(1),
    CONSTRAINT Rain_MD_PK PRIMARY KEY ( STATION, MDATE ),
    FOREIGN KEY(STATION) REFERENCES Stations(STATION) ON DELETE CASCADE
)
WITH (autovacuum_enabled=false)`
)

dataTables.set('Snow_MD', `CREATE TABLE IF NOT EXISTS Snow_MD (
    STATION     VARCHAR(11),
    MDATE       DATE NOT NULL,
    MDSF        SMALLINT,
    DASF        SMALLINT,
    ...
    QFLAG       CHAR(1),
    SFLAG       CHAR(1),
    CONSTRAINT Snow_MD_PK PRIMARY KEY ( STATION, MDATE ),
    FOREIGN KEY(STATION) REFERENCES Stations(STATION) ON DELETE CASCADE
)
WITH (autovacuum_enabled=false)`
)

dataTables.set('Wind_MD', `CREATE TABLE IF NOT EXISTS Wind_MD (
    STATION     VARCHAR(11),
    MDATE       DATE NOT NULL,
    MDWM        SMALLINT,
    DAWM        SMALLINT,
    ...
    QFLAG       CHAR(1),
    SFLAG       CHAR(1),
    CONSTRAINT Wind_MD_PK PRIMARY KEY ( STATION, MDATE ),
    FOREIGN KEY(STATION) REFERENCES Stations(STATION) ON DELETE CASCADE
)
WITH (autovacuum_enabled=false)`
)

dataTables.set('Evaporation_MD', `CREATE TABLE IF NOT EXISTS Evaporation_MD (
    STATION     VARCHAR(11),
    MDATE       DATE NOT NULL,
    MDEV        SMALLINT,
    DAEV        SMALLINT, 
    ...
    QFLAG       CHAR(1),
    SFLAG       CHAR(1),
    CONSTRAINT Evaporation_MD_PK PRIMARY KEY ( STATION, MDATE ),
    FOREIGN KEY(STATION) REFERENCES Stations(STATION) ON DELETE CASCADE
)
WITH (autovacuum_enabled=false)`
)
