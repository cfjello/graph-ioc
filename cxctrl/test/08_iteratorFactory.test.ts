...
export class NumAppend extends Action<string[]> {
    ...
    async main(): Promise<boolean> {   
        ...
        try {
            ...
            let cnt = 0
            let itor = iterate.iteratorFactory< EntryType[], EntryType>( iConf ) // as CxContinuous<EntryType[],EntryType>
...
export class NumAppend2 extends Action<string[]> {
    ...
    async main(): Promise<boolean> {   
        ...
        try {
            ...
            let cnt = 0
            let itor = iterate.iteratorFactory< EntryType[], EntryType>( iConf )
            let obj: IteratorResult<EntryType>
